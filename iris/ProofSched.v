...
Section SchedPostSwtch.
  ...
  Lemma sched_post_swtch `{GEN : GenId} `{CID : CpuId} `{XI : CurCtx}
    ...
    m' !!! Regidx (mword_of_int 18 : mword 5)
      = add_vec (add_vec (mword_of_int (KernelSyms.sched + 0x46) : mword 64) (auipc_off (mword_of_int 0x10 : mword 20))) (sign_extend' 64 (mword_of_int 0x50c : mword 12)) ->
  ...
  Proof.
    ...
    { rgne. assert (HE3v : E3 !!! Regidx (mword_of_int 18 : mword 5)
                     = add_vec (add_vec (add_vec (mword_of_int (KernelSyms.sched + 0x46) : mword 64) (auipc_off (mword_of_int 0x10 : mword 20))) (sign_extend' 64 (mword_of_int 0x50c : mword 12))) (mycpu_a5 cid_word))
...
Section ProofSched.
  ...
  Proof.
    ...
    (* +0x0e jal myproc *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sched + 0x0e)) (mword_of_int 1 : mword 5) (mword_of_int 2095772 : mword 21)
    ...
    assert (Hpcmp : add_vec (mword_of_int (KernelSyms.sched + 0x0e) : mword 64) (sign_extend' 64 (mword_of_int 2095772 : mword 21))
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sched + 0x24)) (mword_of_int 14 : mword 5) (mword_of_int 14 : mword 5) (mword_of_int 0x532 : mword 12)
    ...
    iIntros "Hcg Hpc".
    iEval (repeat rgne) in "Hcg".
    set (C4 := <[Regidx (mword_of_int 14 : mword 5) := regval_into_reg (add_vec (C3 !!! Regidx (mword_of_int 14 : mword 5)) (sign_extend' 64 (mword_of_int 1330 : mword 12)))]> C3).
    change (<[Regidx (mword_of_int 14 : mword 5) := regval_into_reg (add_vec (C3 !!! Regidx (mword_of_int 14 : mword 5)) (sign_extend' 64 (mword_of_int 1330 : mword 12)))]> C3) with C4.
    ...
    { rgne. assert (HC5v : C5 !!! Regidx (mword_of_int 15 : mword 5)
                     = add_vec (mycpu_a5 cid_word)
                         (add_vec (add_vec (mword_of_int (KernelSyms.sched + 0x20) : mword 64) (auipc_off (mword_of_int 0x10 : mword 20)))
                                  (sign_extend' 64 (mword_of_int 0x532 : mword 12)))).
      { rewrite /C5 upd_eq.
        ...
        rewrite (_ : C4 !!! Regidx (mword_of_int 14 : mword 5)
                     = add_vec (add_vec (mword_of_int (KernelSyms.sched + 0x20) : mword 64) (auipc_off (mword_of_int 0x10 : mword 20))) (sign_extend' 64 (mword_of_int 0x532 : mword 12))).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sched + 0x4a)) (mword_of_int 18 : mword 5) (mword_of_int 18 : mword 5) (mword_of_int 0x50c : mword 12)
    ...
    iIntros "Hcg Hpc".
    iEval (repeat rgne) in "Hcg".
    set (D2 := <[Regidx (mword_of_int 18 : mword 5) := regval_into_reg (add_vec (D1 !!! Regidx (mword_of_int 18 : mword 5)) (sign_extend' 64 (mword_of_int 1292 : mword 12)))]> D1).
    change (<[Regidx (mword_of_int 18 : mword 5) := regval_into_reg (add_vec (D1 !!! Regidx (mword_of_int 18 : mword 5)) (sign_extend' 64 (mword_of_int 1292 : mword 12)))]> D1) with D2.
    ...
    { rgne. assert (HD5v : D5 !!! Regidx (mword_of_int 15 : mword 5)
                     = add_vec (mycpu_a5 cid_word)
                         (add_vec (add_vec (mword_of_int (KernelSyms.sched + 0x46) : mword 64) (auipc_off (mword_of_int 0x10 : mword 20)))
                                  (sign_extend' 64 (mword_of_int 0x50c : mword 12)))).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sched + 0x64)) (mword_of_int 11 : mword 5) (mword_of_int 11 : mword 5) (mword_of_int 0x522 : mword 12)
    ...
    iIntros "Hcg Hpc".
    iEval (repeat rgne) in "Hcg".
    set (D12 := <[Regidx (mword_of_int 11 : mword 5) := regval_into_reg (add_vec (D11 !!! Regidx (mword_of_int 11 : mword 5)) (sign_extend' 64 (mword_of_int 1314 : mword 12)))]> D11).
    change (<[Regidx (mword_of_int 11 : mword 5) := regval_into_reg (add_vec (D11 !!! Regidx (mword_of_int 11 : mword 5)) (sign_extend' 64 (mword_of_int 1314 : mword 12)))]> D11) with D12.
    assert (HD12a1 : D12 !!! Regidx (mword_of_int 11 : mword 5)
                     = add_vec (add_vec (mword_of_int (KernelSyms.sched + 0x60) : mword 64) (auipc_off (mword_of_int 0x10 : mword 20))) (sign_extend' 64 (mword_of_int 0x522 : mword 12)))
