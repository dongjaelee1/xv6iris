...
Section ProofCreateMkdir.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (CK + 0x100)) Ra1 Ra1
              (mword_of_int 2108 : mword 12) Z2 (K - 10)%nat b
              ltac:(nz) ltac:(rdok) with "Hcg Hpc []").
    { iApply (cri_100 with "Htext"). }
    iIntros (CIDm3 Hqm3) "Hcg Hpc".
    pose (Z3 := <[Regidx Ra1 := regval_into_reg
                  (add_vec (rget Z2 Ra1)
                     (sign_extend' 64 (mword_of_int 2108 : mword 12)))]> Z2).
    change (<[Regidx Ra1 := regval_into_reg
                  (add_vec (rget Z2 Ra1)
                     (sign_extend' 64 (mword_of_int 2108 : mword 12)))]> Z2) with Z3.
 ...
 γf
    ...
    - (* =============================================================== *)
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (CK + 0x114)) Ra1 Ra1
                (mword_of_int 2096 : mword 12) Y2 (K - 10)%nat b
                ltac:(nz) ltac:(rdok) with "Hcg Hpc []").
      { iApply (cri_114 with "Htext"). }
      iIntros (CIDe4 Hqe4) "Hcg Hpc".
      pose (Y3 := <[Regidx Ra1 := regval_into_reg
                    (add_vec (rget Y2 Ra1)
                       (sign_extend' 64 (mword_of_int 2096 : mword 12)))]> Y2).
      change (<[Regidx Ra1 := regval_into_reg
                    (add_vec (rget Y2 Ra1)
                       (sign_extend' 64 (mword_of_int 2096 : mword 12)))]> Y2) with Y3.
