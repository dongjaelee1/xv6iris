...
Section ProofIinit.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.iinit + 0x12)) (mword_of_int 11 : mword 5) (mword_of_int 11 : mword 5) (mword_of_int 772 : mword 12)
              R3 (K - 6)%nat b ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (iii_12 with "Htext"). }
    iIntros (CID9 Hs9) "Hcg Hpc".
    set (R4 := <[Regidx (mword_of_int 11 : mword 5) := regval_into_reg (add_vec (R3 !!! Regidx (mword_of_int 11 : mword 5)) (sign_extend' 64 (mword_of_int 772 : mword 12)))]> R3).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.iinit + 0x1a)) (mword_of_int 10 : mword 5) (mword_of_int 10 : mword 5) (mword_of_int 2060 : mword 12)
              R5 (K - 6)%nat b ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (iii_1a with "Htext"). }
    iIntros (CID11 Hs11) "Hcg Hpc".
    set (R6 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg (add_vec (R5 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 2060 : mword 12)))]> R5).
    ...
    (* ===== jal initlock ===== *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.iinit + 0x1e)) (mword_of_int 1 : mword 5) (mword_of_int 2087556 : mword 21)
    ...
    assert (Htgtil : add_vec (mword_of_int (KernelSyms.iinit + 0x1e) : mword 64) (sign_extend' 64 (mword_of_int 2087556 : mword 21)) = mword_of_int KernelSyms.initlock)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.iinit + 0x26)) (mword_of_int 9 : mword 5) (mword_of_int 9 : mword 5) (mword_of_int 2088 : mword 12)
              T1 (K - 6)%nat b ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (iii_26 with "Htext"). }
    iIntros (CID15 Hs15) "Hcg Hpc".
    set (T2 := <[Regidx (mword_of_int 9 : mword 5) := regval_into_reg (add_vec (T1 !!! Regidx (mword_of_int 9 : mword 5)) (sign_extend' 64 (mword_of_int 2088 : mword 12)))]> T1).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.iinit + 0x2e)) s3i s3i (mword_of_int 688 : mword 12)
              T3 (K - 6)%nat b ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (iii_2e with "Htext"). }
    iIntros (CID17 Hs17) "Hcg Hpc".
    set (T4 := <[Regidx s3i := regval_into_reg (add_vec (T3 !!! Regidx s3i) (sign_extend' 64 (mword_of_int 688 : mword 12)))]> T3).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.iinit + 0x36)) s2i s2i (mword_of_int 744: mword 12)
              T5 (K - 6)%nat b ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (iii_36 with "Htext"). }
    iIntros (CID19 Hs19) "Hcg Hpc".
    set (T6 := <[Regidx s2i := regval_into_reg (add_vec (T5 !!! Regidx s2i) (sign_extend' 64 (mword_of_int 744 : mword 12)))]> T5).
