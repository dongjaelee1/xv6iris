...
Section BreadBlocks.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bread + 0x52)) Ra0 Ra0 (mword_of_int 1476 : mword 12)
    ...
    set (H4 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (H3 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1476 : mword 12)))]> H3).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bread + 0x56)) Rra (mword_of_int 2088996 : mword 21)
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bread + 0xa4)) Ra0 Ra0 (mword_of_int 1394 : mword 12)
    ...
    set (C3 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (C2 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1394 : mword 12)))]> C2).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bread + 0xa8)) Rra (mword_of_int 2088914 : mword 21)
  ...
  Proof.
    ...
    - (* ======== refcnt <> 0: advance to b->prev ======== *)
      ...
      + (* ---- the prefix is exhausted: fall through to panic ---- *)
        ...
        iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bread + 0x88)) Ra0 Ra0 (mword_of_int 1758 : mword 12)
        ...
        set (Q2 := <[Regidx Ra0 := regval_into_reg
                      (add_vec (Q1 !!! Regidx Ra0)
                         (sign_extend' 64 (mword_of_int 1758 : mword 12)))]> Q1).
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bread + 0x8c)) Rra (mword_of_int 2087750 : mword 21)
        ...
        assert (Htgtpanic : add_vec (mword_of_int (KernelSyms.bread + 0x8c) : mword 64)
                              (sign_extend' 64 (mword_of_int 2087750 : mword 21))
  ...
  Proof.
    ...
    assert (Hhp : add_vec (rget Q1 Rs1) (sign_extend' 64 (mword_of_int 2142 : mword 12))
                  = bprev bhead).
    ...
    iApply (wp_ld_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.bread + 0x68)) Rs1 Rs1 (mword_of_int 2142 : mword 12)
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bread + 0x70)) Ra5 Ra5 (mword_of_int 2062 : mword 12)
    ...
    set (Q4 := <[Regidx Ra5 := regval_into_reg
                  (add_vec (Q3 !!! Regidx Ra5)
                     (sign_extend' 64 (mword_of_int 2062 : mword 12)))]> Q3).
...
Section ProofBread.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bread + 0x16)) Ra0 Ra0 (mword_of_int 1536 : mword 12)
    ...
    set (R6 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (R5 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1536 : mword 12)))]> R5).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bread + 0x1a)) Rra (mword_of_int 2088920 : mword 21)
    ...
    assert (Hhn : add_vec (rget W1 Rs1) (sign_extend' 64 (mword_of_int 2220 : mword 12))
                  = bnext bhead).
    ...
    iApply (wp_ld_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.bread + 0x22)) Rs1 Rs1 (mword_of_int 2220 : mword 12)
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bread + 0x2a)) Ra5 Ra5 (mword_of_int 2132 : mword 12)
    ...
    set (W4 := <[Regidx Ra5 := regval_into_reg
                  (add_vec (W3 !!! Regidx Ra5)
                     (sign_extend' 64 (mword_of_int 2132 : mword 12)))]> W3).
