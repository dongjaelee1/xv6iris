...
(* `echo w1 ... wn' and `echo w1 ... wn | cat' lines at the console of an  *)
(* unmodified xv6, each line as a burst if they like, and nothing but the   *)
(* line and sh's own diagnostics ever reaches the console.  The echo        *)
(* application's theorem ([UInitPipeAdequacy.echo_adequacy]) is a          *)
(* corollary in the same cone, so this is its audit too (design SS0.2;    *)
(* it retired [EchoAssumptions.v]).                                        *)
(*                                                                        *)
...
(* [UCat*] program tier and the stage ([PipeDisc]/[PipeOut]/[PipeLinks]/   *)
(* [AppPipe]).  A grep for [Axiom] and [Admitted] cannot see a sealed       *)
...
(* statement to MEAN what they think -- is above all [PipeDisc.v]:         *)
(* [disc_p], [good_out_p], [palt_ok], [pcont] and [pipe_phi] ARE the       *)
(* specification (and [EchoDisc.v]'s [disc]/[good_out] for the corollary). *)
