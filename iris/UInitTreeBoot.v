...
(*      [UInitSh.init_exec_sup_of_sh_slot] (UInitSh.v:1157), whose        *)
(*      Coq-level premise is [UInitSh.cons_cred_holds] -- ten laws over   *)
(*      the console credential record.  At the tree's record              *)
(*      ([UInitTree.tree_cc]) the EIGHTH of them (UInitSh.v:562) reads,   *)
...
(*      [cons_cred_holds]'s eighth conjunct as an UPDATE                  *)
...
(*      record's: [cons_cred_holds]'s FIRST conjunct (UInitSh.v:535) is   *)
