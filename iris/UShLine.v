...
Section UShLine.
  ...
  (* =================================================================== *)
  (*  S4  R3'S TARGET, AND THE ONE THING THAT WAS BETWEEN IT AND A LEMMA. *)
  (*                                                                      *)
  (*  HISTORY (the top theorem names none of this now -- [Hsh_owed] went  *)
  (*  with redesign R3; what follows is the argument that retired it).    *)
  (*  What the top theorem named was                                      *)
  (*                                                                      *)
  ...
  (*                                                                      *)
  (*  WHAT STAYED NAMED, and who owns it:                                 *)
  (*      [UkSh.sh_deps]                 -- [Hsh_owed]'s own conjunct,     *)
  (*                                        write(16), E5's; a wand off    *)
  (*                                        the taint now, proved at       *)
