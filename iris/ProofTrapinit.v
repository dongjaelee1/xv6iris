...
Section CodeTrapinitBundle.
  ...
  Lemma tri_code :
    kernel_text -∗ ilw_code KernelSyms.trapinit (mword_of_int 5) (mword_of_int 22)
                            (mword_of_int 3418) (mword_of_int 3394) (mword_of_int 2090674).
  Proof.
...
Section ProofTrapinit.
  ...
  Proof.
    ...
    iApply (ILW.wp_initlock_wrapper_sconf KT1 m K KernelSyms.trapinit
              (mword_of_int 5) (mword_of_int 22) (mword_of_int 3418) (mword_of_int 3394)
              (mword_of_int 2090674) lk name "time"%string vlock vname vcpu b p HK
