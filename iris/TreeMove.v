...
(*                                                                       *)
(*  WALL A, the other half: mkdir CAN NOW CARRY A CURSOR.                 *)
(*  [SpecSysMkdir.mkdir_au_at] is the path-fixed bundle ([mknod_au_at]'s  *)
(*  twin: the walk under [ArgPath.arg_path_of] at argument 0, the four    *)
(*  legs at [SysMknodDefs.npar_cur]), and [SpecCreate.cre_commits_mono]   *)
(*  is the cursor ISO lifted over the whole four-leg bundle.  unlink      *)
(*  still takes the [forall pl] one-shot; section 7.7 writes down its     *)
(*  recipe line by line.                                                  *)
(*                                                                       *)
