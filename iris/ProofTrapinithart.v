...
Section TrapinithartBody.
  ...
  Proof using .
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.trapinithart + 0x0c)) (mword_of_int 15 : mword 5) (mword_of_int 15 : mword 5) (mword_of_int 0x156 : mword 12)
    ...
    iIntros "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (A1 := <[Regidx (mword_of_int 15 : mword 5) := regval_into_reg (add_vec (A0 !!! Regidx (mword_of_int 15 : mword 5)) (sign_extend' 64 (mword_of_int 342 : mword 12)))]> A0).
