...
Section EscrowDefs.
  ...
  Proof using . rewrite /committedA. apply _. Qed.
  ...
  Proof using . rewrite /redeem_ticketA. apply _. Qed.
  ...
  Proof using . rewrite /crp_elem. apply _. Qed.
  ...
  Proof using . rewrite /reg_half. apply _. Qed.
  Global Instance reg_full_timeless z ge gr : Timeless (reg_full z ge gr).
  Proof using . rewrite /reg_full. apply _. Qed.
  ...
  Proof using . rewrite /region_pending. apply _. Qed.
