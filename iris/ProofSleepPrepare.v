...
Section ProofSleepPrepare.
  ...
  Proof using .
    ...
    (* ===================== p = myproc() ===================== *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sleep_prepare + 0x0e)) spr_ra (mword_of_int 2095540 : mword 21)
              A2 (av - 4)%nat b
    ...
    assert (Hjmp : add_vec (mword_of_int (KernelSyms.sleep_prepare + 0x0e) : mword 64) (sign_extend' 64 (mword_of_int 2095540 : mword 21)) = mword_of_int KernelSyms.myproc)
