...
Section ProofKilled.
  ...
  Proof using .
    ...
    { rewrite /A2 upd_ne; [| vm_compute; discriminate].
      ...
      rewrite /M1 upd_ne; [| vm_compute; discriminate]. exact Ha0. }
    (* +0x0e: jal ra,acquire *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.killed + 0x0e)) kl_ra (mword_of_int 2091558 : mword 21)
              A2 (av - 4)%nat b
    ...
    assert (Hjacq : add_vec (mword_of_int (KernelSyms.killed + 0x0e) : mword 64) (sign_extend' 64 (mword_of_int 2091558 : mword 21)) = mword_of_int KernelSyms.acquire)
    ...
    (* +0x18: jal ra,release *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.killed + 0x18)) kl_ra (mword_of_int 2091684 : mword 21)
    ...
    assert (Hjrel : add_vec (mword_of_int (KernelSyms.killed + 0x18) : mword 64) (sign_extend' 64 (mword_of_int 2091684 : mword 21)) = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
