...
(*                                                                       *)
(*   4  /INIT'S MKNOD, at [UkTreeCreate.wp_uk_ecall_mknod_own]: the deed  *)
...
(* tree's flag is the deed, and a deed is not persistent.  The consumer   *)
(* ([UInitTreeBoot.tree_Hinit_boot]) therefore cases on the era's own     *)
(* tree and takes the honest at-boot arm where the console is already     *)
(* there.                                                                *)
(* ===================================================================== *)
