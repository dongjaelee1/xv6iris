...
Section ProofKwait.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KW + 0xfe)) Ra0 Ra0 (mword_of_int 240 : mword 12)
    ...
    set (T1 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (T0 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 240 : mword 12)))]> T0).
    change (<[Regidx Ra0 := regval_into_reg
                  (add_vec (T0 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 240 : mword 12)))]> T0) with T1.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0x102)) Rra
              (mword_of_int 2091392 : mword 21) T1 (trap_res eb + (K - 10))%nat false
    ...
    assert (Hjrel : add_vec (mword_of_int (KW + 0x102) : mword 64)
                      (sign_extend' 64 (mword_of_int 2091392 : mword 21))
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0x96)) Rra
              (mword_of_int 2091500 : mword 21) U0 (trap_res eb + (K - 10))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KW + 0x9e)) Ra0 Ra0 (mword_of_int 336 : mword 12)
    ...
    set (U3 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (U2 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 336 : mword 12)))]> U2).
    change (<[Regidx Ra0 := regval_into_reg
                  (add_vec (U2 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 336 : mword 12)))]> U2) with U3.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0xa2)) Rra
              (mword_of_int 2091488 : mword 21) U3 (trap_res eb + (K - 10))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjr2 : add_vec (mword_of_int (KW + 0xa2) : mword 64)
                     (sign_extend' 64 (mword_of_int 2091488 : mword 21))
                   = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0x6c)) Rra
              (mword_of_int 2091542 : mword 21) R2 (trap_res eb + (K - 10))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KW + 0x74)) Ra0 Ra0 (mword_of_int 378 : mword 12)
    ...
    set (R5 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (R4 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 378 : mword 12)))]> R4).
    change (<[Regidx Ra0 := regval_into_reg
                  (add_vec (R4 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 378 : mword 12)))]> R4) with R5.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0x78)) Rra
              (mword_of_int 2091530 : mword 21) R5 (trap_res eb + (K - 10))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjr2 : add_vec (mword_of_int (KW + 0x78) : mword 64)
                     (sign_extend' 64 (mword_of_int 2091530 : mword 21))
                   = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hjr2) in "Hpc".
  ...
  Proof.
    ...
    - (* ===== addr != 0: copyout(p->pagetable, addr, &pp->xstate, 4) ===== *)
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KW + 0x58)) Rra
                (mword_of_int 2093836 : mword 21) F5 (trap_res eb + (K - 10))%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc []").
      ...
      assert (Hjco : add_vec (mword_of_int (KW + 0x58) : mword 64)
                       (sign_extend' 64 (mword_of_int 2093836 : mword 21))
    ...
    { iIntros (fuel). iInduction fuel as [|fuel IHf] "IHf".
      ...
      + (* ===== our child: take its lock and look at its state ===== *)
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KW + 0xba)) Rra
                  (mword_of_int 2091328 : mword 21) S1 (trap_res eb + (K - 10))%nat false
                  ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc []").
        ...
        assert (Hjacq : add_vec (mword_of_int (KW + 0xba) : mword 64)
                          (sign_extend' 64 (mword_of_int 2091328 : mword 21))
        ...
        * (* ===== not a ZOMBIE: release, set havekids, continue ===== *)
          ...
          iApply (wp_jal_s_sconf (mword_of_int (KW + 0xc6)) Rra
                    (mword_of_int 2091452 : mword 21) S4 (trap_res eb + (K - 10))%nat false
                    ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                    with "Hcg Hpc []").
          ...
          assert (Hjrel : add_vec (mword_of_int (KW + 0xc6) : mword 64)
                            (sign_extend' 64 (mword_of_int 2091452 : mword 21))
                          = mword_of_int KernelSyms.release)
            by (apply bv_eq; vm_compute; reflexivity).
          iEval (rewrite Hjrel) in "Hpc".
    ...
    - (* ===== there are kids: ask whether we were killed ===== *)
      ...
      + (* ===== still alive: sleep on p, then scan again ===== *)
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KW + 0xe0)) Rra
                  (mword_of_int 2091426 : mword 21) T4 (trap_res eb + (K - 10))%nat false
                  ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc []").
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KW + 0xea)) Rra
                  (mword_of_int 2091280 : mword 21) T7 (K - 10)%nat eb
                  ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc []").
        ...
        assert (Hjaq : add_vec (mword_of_int (KW + 0xea) : mword 64)
                         (sign_extend' 64 (mword_of_int 2091280 : mword 21))
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KW + 0xf4)) Rs1 Rs1
              (mword_of_int 1298 : mword 12) D1 (trap_res eb + (K - 10))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    ...
    set (D2 := <[Regidx Rs1 := regval_into_reg
                  (add_vec (D1 !!! Regidx Rs1)
                     (sign_extend' 64 (mword_of_int 1298 : mword 12)))]> D1).
    change (<[Regidx Rs1 := regval_into_reg
                  (add_vec (D1 !!! Regidx Rs1)
                     (sign_extend' 64 (mword_of_int 1298 : mword 12)))]> D1) with D2.
...
Section ProofKwaitMain.
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0x18)) Rra
              (mword_of_int 2094866 : mword 21) P2 (av - 10)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjmy : add_vec (mword_of_int (KW + 0x18) : mword 64)
                     (sign_extend' 64 (mword_of_int 2094866 : mword 21))
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0x26)) Rra
              (mword_of_int 2091476 : mword 21) P6 (av - 10)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjacq : add_vec (mword_of_int (KW + 0x26) : mword 64)
                      (sign_extend' 64 (mword_of_int 2091476 : mword 21))
                    = mword_of_int KernelSyms.acquire) by pcstep.
    iEval (rewrite Hjacq) in "Hpc".
