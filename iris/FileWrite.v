...
(*      and is therefore PREFIX-CLOSED: the node used to say "these bytes *)
(*      are a run of the caller's image at this base" and NOT "this is    *)
(*      the whole chunk".  [FsAbsWriteFire.awrite_full_at] now carries    *)
